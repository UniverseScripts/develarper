...
def test_local_slm_basic() -> None:
    ...
    response = engine.generate(prompt="Hi", system_prompt="You are a helpful assistant. Output exactly 'Hello' and nothing else.", max_tokens=10)
...
def test_local_slm_escalation() -> None:
    ...
    response = engine.generate(prompt="This is a complex question requiring escalation.", system_prompt="Always output __ESCALATE__", max_tokens=10)
